//
//  PartnerActivityDetailController.m
//  WeiZongBuIphone
//
//  Created by Donald on 15/3/9.
...
#import "WZBPartnerActivity.h"

@interface PartnerActivityDetailController ()<WZBRequestDelegate>
{
    UIView *_navView;
    UIView *_topNaviV;
    UILabel *_dateLabel;
...
@implementation PartnerActivityDetailController
...
-(void)request:(WZBRequest *)request didFinishLoadingWithResult:(id)result
{
    ...
    WZBPartnerActivity *activity = [[WZBPartnerActivity alloc] init];
