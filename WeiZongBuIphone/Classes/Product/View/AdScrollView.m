...
//    _rightImageView.image = [UIImage imageNamed:_imageNameArray[2]];
    ...
    if (_imageNameArray.count==1) {
        [WZBImageTool downLoadImage:_imageNameArray[0] imageView:_centerImageView];
    }
    else if(_imageNameArray.count==2)
    {
        [WZBImageTool downLoadImage:_imageNameArray[0] imageView:_leftImageView];
        [WZBImageTool downLoadImage:_imageNameArray[1] imageView:_centerImageView];
    }
    else
    {
        [WZBImageTool downLoadImage:_imageNameArray[0] imageView:_leftImageView];
        [WZBImageTool downLoadImage:_imageNameArray[1] imageView:_centerImageView];
        [WZBImageTool downLoadImage:_imageNameArray[2] imageView:_rightImageView];
    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    [WZBImageTool downLoadImage:_imageNameArray[(currentImage-1)%_imageNameArray.count] imageView:_leftImageView];
    [WZBImageTool downLoadImage:_imageNameArray[currentImage%_imageNameArray.count] imageView:_centerImageView];
    [WZBImageTool downLoadImage:_imageNameArray[(currentImage+1)%_imageNameArray.count] imageView:_rightImageView];
