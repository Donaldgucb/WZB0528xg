...
@interface ShowCollectionController ()<UITableViewDataSource,UITableViewDelegate,WZBRequestDelegate>
{
...
@implementation ShowCollectionController
...
-(void)baseSetting
{
    ...
    [listTable registerNib:[UINib nibWithNibName:@"ExhibitionCell" bundle:nil]  forCellReuseIdentifier:@"exhibitionCell"];
...
{
    NSString *url = @"wzbAppService/collection/getCollectionList.htm?page=0&offset=100&type=5&";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ExhibitionCell *cell = [_listTable dequeueReusableCellWithIdentifier:Identify forIndexPath:indexPath];
    if (cell==nil) {
        cell = [[ExhibitionCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:Identify];
    }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    detail.webUrl =url;
    detail.enterCollecion=YES;
    detail.listCollecionID = data.collectionID;
