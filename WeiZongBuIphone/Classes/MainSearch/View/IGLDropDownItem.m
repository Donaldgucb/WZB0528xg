...
- (void)updateLayout
{
    ...
    [self.iconImageView setFrame:CGRectMake(5, selfHeight/4, selfHeight/3, selfHeight/2)];
    if (self.iconImage) {
//        [self.textLabel setFrame:CGRectMake(CGRectGetMaxX(self.iconImageView.frame), 0, selfWidth - CGRectGetMaxX(self.iconImageView.frame), selfHeight)];
         [self.textLabel setFrame:CGRectMake(selfHeight/2+8, 0, selfWidth - CGRectGetMaxX(self.iconImageView.frame), selfHeight)];
    } else {
