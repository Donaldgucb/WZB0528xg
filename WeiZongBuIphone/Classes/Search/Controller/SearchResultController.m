...
@interface SearchResultController ()<WZBRequestDelegate,UITableViewDelegate,UITableViewDataSource>
{
...
{
    NSString *url = [NSString stringWithFormat:@"%@%@",ProductSearchUrl,_searchString];
...
-(void)request:(WZBRequest *)request didFinishLoadingWithResult:(id)result
{
    ...
    if (array.count>0) {
        for (NSDictionary *dict in array) {
            ...
            search.image = [dict objectForKey:@"image"];
