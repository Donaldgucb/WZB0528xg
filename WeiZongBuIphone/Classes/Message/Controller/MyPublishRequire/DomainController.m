...
@interface DomainController ()<UITableViewDataSource,UITableViewDelegate,WZBRequestDelegate>
...
@implementation DomainController
...
-(void)requestAndGetDomain
{
    NSString *url = @"wzbAppService/meta/getFirstDomain.htm";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    WZBDomain *domain = [[WZBDomain alloc] init];
    domain = _resultArray[indexPath.row];
    SubDomainController *sub = [[SubDomainController alloc] init];
    sub.subDomain = domain.subField;
    sub.domainID = domain.mainId;
