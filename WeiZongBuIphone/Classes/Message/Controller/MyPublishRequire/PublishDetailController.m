...
@interface PublishDetailController ()<UITextViewDelegate>
...
@implementation PublishDetailController
...
{
    [self.navigationController popViewControllerAnimated:YES];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ChangeDetailNotification" object:self userInfo:@{@"content":_detailContent.text}];
}
